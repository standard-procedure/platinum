...
class Platinum::Theme
  ...
  DEFAULT_CONFIG = {
    ...
    # alerts
    info_alert_title_frame: %w[fixed top-14 left-1 right-1 md:top-26 md:left-auto md:right-8 min-w-sm w-auto md:min-w-xl font-medium rounded-md backdrop-blur-lg p-4 mx-2 my-4 transition-transform scale-0 open:scale-100 duration-2000 border border-green-500 bg-green-100/30 text-green-700 dark:bg-green-900/30 dark:text-green-300],
    success_alert_title_frame: %w[fixed top-14 left-1 right-1 md:top-26 md:left-auto md:right-8 min-w-sm w-auto md:min-w-xl font-medium rounded-md backdrop-blur-lg p-4 mx-2 my-4 transition-transform scale-0 open:scale-100 duration-2000 border border-green-700 bg-green-300/30 text-green-700 dark:border-green-300 dark:bg-green-700/30 dark:text-green-300],
    warning_alert_title_frame: %w[fixed top-14 left-1 right-1 md:top-26 md:left-auto md:right-8 min-w-sm w-auto md:min-w-xl font-medium rounded-md backdrop-blur-lg p-4 mx-2 my-4 transition-transform scale-0 open:scale-100 duration-2000 border border-orange-700 bg-orange-300/30 text-orange-700 dark:border-orange-300 dark:bg-orange-700/30 dark:text-orange-300],
    danger_alert_title_frame: %w[fixed top-14 left-1 right-1 md:top-26 md:left-auto md:right-8 min-w-sm w-auto md:min-w-xl font-medium rounded-md backdrop-blur-lg p-4 mx-2 my-4 transition-transform scale-0 open:scale-100 duration-2000 border border-red-700 bg-red-300/30 text-red-700 dark:border-red-300 dark:bg-red-700/30 dark:text-red-300]
  }.freeze
