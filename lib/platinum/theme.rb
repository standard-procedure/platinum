...
class Platinum::Theme
  ...
  DEFAULT_CONFIG = {
    ...
    footer: %w[fixed inset-x-0 bottom-0 z-20 backdrop-blur-sm border-t border-white bg-transparent text-neutral-800 hover:border-neutral-100 hover:bg-white/20 hover:text-neutral-900 dark:border-black dark:bg-transparent dark:text-neutral-200 dark:hover:border-neutral-900 dark:hover:bg-black/20 dark:hover:text-neutral-400],
    ...
    toolbar_container: %w[flex flex-col overflow-y-auto md:flex-row md:overflow-x-auto flex-nowrap gap-1 p-1 items-stretch justify-start md:items-center ms:justify-start rounded-md backdrop-blur-lg border border-neutral-50 bg-white/30 text-neutral-800 dark:border-neutral-900 dark:bg-black/30 dark:text-neutral-200],
