...
class Platinum::Theme
  ...
  DEFAULT_CONFIG = {
    ...
    expander_summary: "z-1 shrink-0 transition duration-500 rounded-xl px-4 py-1 group-open:rotate-90 group-open:backdrop-blue-lg group-open:border group-open:border-neutral-300 group-open:bg-white/30 group-open:text-neutral-600 hover:group-open:border-neutral-600 hover:group-open:bg-neutral-100 hover:group-open:text-neutral-800",
