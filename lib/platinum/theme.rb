...
class Platinum::Theme
  ...
  DEFAULT_CONFIG = {
    ...
    overlay: "border rounded-md backdrop-blur-lg bg-stone-200/10 border-white hover:bg-stone-50/30 dark:bg-stone-900/10 dark:border-black dark:hover:bg-stone-900/30",
