...
class Platinum::Theme
  ...
  DEFAULT_CONFIG = {
    ...
    # buttons
    button: "px-4 py-1 block w-full md:w-auto font-medium backdrop-blur-lg hover:animate-pulse border rounded-md text-neutral-500 bg-neutral-200/80 border-neutral-500 hover:text-neutral-900 hover:bg-neutral-400 hover:border-neutral-700 dark:text-neutral-500 dark:bg-neutral-800/80 dark:border-neutral-500 dark:hover:text-neutral-300 dark:hover:bg-neutral-600 dark:hover:border-neutral-300",
    primary_button: "px-4 py-1 block w-full md:w-auto font-medium backdrop-blur-lg hover:animate-pulse border rounded-md text-neutral-100 bg-neutral-700/80 border-neutral-900 hover:text-green-400 hover:bg-green-900 hover:border-neutral-300 dark:text-green-600 dark:bg-neutral-500/80 dark:border-green-700 dark:hover:text-green-400 dark:hover:bg-green-700 dark:hover:border-green-400",
    success_button: "px-4 py-1 block w-full md:w-auto font-light backdrop-blur-lg hover:animate-pulse border rounded-md text-green-100 bg-green-700/80 border-green-700 hover:text-green-100 hover:bg-green-800 hover:border-green-700 dark:text-green-200 dark:bg-green-600/80 dark:border-green-200 dark:hover:text-green-100 dark:hover:bg-green-500 dark:hover:border-green-100",
    warning_button: "px-4 py-1 w-full md:w-auto font-medium backdrop-blur-lg hover:animate-pulse border rounded-md text-amber-100 bg-amber-700/80 border-amber-700 hover:text-amber-100 hover:bg-amber-800 hover:border-amber-700 dark:text-amber-200 dark:bg-amber-600/80 dark:border-amber-200 dark:hover:text-amber-100 dark:hover:bg-amber-500 dark:hover:border-amber-100",
    danger_button: "px-4 py-1 w-full md:w-auto font-medium backdrop-blur-lg hover:animate-pulse border rounded-md text-red-100 bg-red-700/80 border-red-700 hover:text-red-100 hover:bg-red-800 hover:border-red-700 dark:text-red-200 dark:bg-red-600/80 dark:border-red-200 dark:hover:text-red-100 dark:hover:bg-red-500 dark:hover:border-red-100",
    info_button: "px-4 py-1 w-full md:w-auto font-medium backdrop-blur-lg hover:animate-pulse border rounded-md text-sky-100 bg-sky-700/80 border-sky-700 hover:text-sky-100 hover:bg-sky-800 hover:border-sky-700 dark:text-sky-200 dark:bg-sky-600/80 dark:border-sky-200 dark:hover:text-sky-100 dark:hover:bg-sky-500 dark:hover:border-sky-100",
    # links
