...
class Platinum::Theme
  ...
  DEFAULT_CONFIG = {
    ...
    main: %w[flex-1 flex flex-col justify-start items-stretch pt-12 pb-12],
    header: %w[fixed inset-x-0 top-0 z-10 backdrop-blur-sm border-b border-white bg-transparent text-neutral-800 hover:border-neutral-100 hover:bg-white/20 hover:text-neutral-900 dark:border-black dark:bg-transparent dark:text-neutral-200 dark:hover:border-neutral-900 dark:hover:bg-black/20 dark:hover:text-neutral-400],
    footer: %w[fixed inset-x-0 bottom-0 z-20 md:backdrop-blur-sm md:border-t border-white bg-transparent text-neutral-800 hover:border-neutral-100 hover:bg-white/20 hover:text-neutral-900 dark:border-black dark:bg-transparent dark:text-neutral-200 dark:hover:border-neutral-900 dark:hover:bg-black/20 dark:hover:text-neutral-400],
    ...
    desktop_header_row: %w[hidden md:flex h-10 px-4 backdrop-blur-sm bg-transparent],
    toolbar_container: %w[flex flex-col overflow-y-auto md:flex-row md:overflow-x-auto flex-nowrap text-nowrap gap-1 p-1 items-stretch justify-start md:items-center ms:justify-start rounded-md backdrop-blur-lg border border-neutral-50 bg-white/30 text-neutral-800 dark:border-neutral-900 dark:bg-black/30 dark:text-neutral-200],
    filter_container: %w[flex flex-col overflow-y-auto md:flex-row md:overflow-x-auto flex-nowrap items-stretch justify-start md:items-center ms:justify-start gap-1 rounded-md backdrop-blur-lg border-neutral-50 bg-neutral-200/10 text-neutral-300 hover:border-white hover:bg-neutral-300 hover:text-neutral-800 dark:border-neutral-900 dark:bg-neutral-800/10 dark:text-neutral-700 dark:hover:border-black dark:hover:bg-neutral-700 dark:hover:text-neutral-800],
    filter_link: "px-2 py-1 block w-full md:w-auto text-sm font-light text-nowrap backdrop-blur-lg rounded-md text-neutral-600 bg-neutral-100/10 border-neutral-300 hover:text-neutral-100 hover:bg-neutral-800/80 hover:border-neutral-600 dark:text-neutral-400 dark:bg-neutral-700/10 dark:border-neutral-700 dark:hover:text-neutral-400 dark:hover:bg-neutral-600/80 dark:hover:border-neutral-400 hover:animate-pulse",
    ...
    drawer_button: %w[pointer-events-auto px-4 py-1 block font-light backdrop-blur-lg hover:animate-pulse border rounded-full text-black bg-green-100/10 border-white hover:text-neutral-500 hover:bg-green-100 hover:border-neutral-200 dark:text-white dark:bg-green-900/10 dark:border-black dark:hover:text-neutral-300 dark:hover:bg-green-900 dark:hover:border-neutral-800],
    ...
    pagination_container: %w[backdrop-blur-lg hover:bg-white dark:hover:bg-black],
    search_container: %w[backdrop-blur-lg hover:bg-white dark:hover:bg-black],
    # containers
    ...
    card_outer: %w[block m-1 p-0 md:p-2 rounded-md border border-neutral-200 bg-neutral-100 dark:border-neutral-900 dark:bg-neutral-800],
    ...
    inset_button: %w[pointer-events-auto rounded-md px-2 py-1 backdrop-blur-xs text-neutral-400 bg-neutral-200/30 hover:bg-green-100 hover:text-green-700 dark:text-neutral-600 dark:bg-neutral-800/30 dark:hover:bg-green-900 dark:hover:text-green-300],
    inset_danger_button: %w[pointer-events-auto rounded-md px-2 py-1 backdrop-blur-xs text-neutral-400 bg-neutral-200/30 hover:bg-red-100 hover:text-red-700 dark:text-neutral-600 dark:bg-neutral-800/30 dark:hover:bg-red-900 dark:hover:text-red-300],
    ...
    # buttons
    button: "pointer-events-auto px-4 py-1 block w-full md:w-auto font-medium backdrop-blur-lg hover:animate-pulse border rounded-md text-neutral-500 bg-neutral-100/80 border-neutral-500 hover:text-neutral-900 hover:bg-neutral-400 hover:border-neutral-700 dark:text-neutral-500 dark:bg-neutral-900/80 dark:border-neutral-500 dark:hover:text-neutral-300 dark:hover:bg-neutral-600 dark:hover:border-neutral-300",
    primary_button: "pointer-events-auto px-4 py-1 block w-full md:w-auto font-medium backdrop-blur-lg hover:animate-pulse border rounded-md text-neutral-100 bg-neutral-700/80 border-neutral-900 hover:text-neutral-400 hover:bg-neutral-900 hover:border-neutral-300 dark:text-neutral-400 dark:bg-neutral-500/80 dark:border-neutral-400 dark:hover:text-neutral-300 dark:hover:bg-neutral-700 dark:hover:border-neutral-300",
    success_button: "pointer-events-auto px-4 py-1 w-full md:w-auto font-medium backdrop-blur-lg hover:animate-pulse border rounded-md text-green-700 bg-green-100/80 border-green-700 hover:text-green-100 hover:bg-green-800 hover:border-green-700 dark:text-green-700 dark:bg-green-900/80 dark:border-green-700 dark:hover:text-green-200 dark:hover:bg-green-700 dark:hover:border-green-200",
    warning_button: "pointer-events-auto px-4 py-1 w-full md:w-auto font-medium backdrop-blur-lg hover:animate-pulse border rounded-md text-amber-700 bg-neutral-50/80 border-amber-700 hover:text-amber-100 hover:bg-amber-800 hover:border-amber-700 dark:text-amber-700 dark:bg-neutral-900/80 dark:border-amber-700 dark:hover:text-amber-200 dark:hover:bg-amber-700 dark:hover:border-amber-200",
    danger_button: "pointer-events-auto px-4 py-1 w-full md:w-auto font-medium backdrop-blur-lg hover:animate-pulse border rounded-md text-red-700 bg-neutral-100/80 border-red-700 hover:text-red-100 hover:bg-red-800 hover:border-red-700 dark:text-red-900 dark:bg-neutral-900/80 dark:border-red-800 dark:hover:text-red-200 dark:hover:bg-red-700 dark:hover:border-red-200",
    info_button: "pointer-events-auto px-4 py-1 w-full md:w-auto font-medium backdrop-blur-lg hover:animate-pulse border rounded-md text-sky-700 bg-neutral-50/80 border-sky-700 hover:text-sky-100 hover:bg-sky-800 hover:border-sky-700 dark:text-sky-700 dark:bg-neutral-900/80 dark:border-sky-700 dark:hover:text-sky-200 dark:hover:bg-sky-700 dark:hover:border-sky-200",
    # links
    ...
    expander_summary: "z-1 shrink-0 transition duration-500 rounded-xl px-4 py-1 group-open:rotate-15 group-open:backdrop-blur-lg group-open:border group-open:border-neutral-300 group-open:bg-white/10 group-open:text-neutral-600/10 hover:group-open:border-neutral-600 hover:group-open:bg-neutral-100/10 hover:group-open:text-neutral-800/10",
    pagination_inner: %w[text-xs font-light backdrop-blur-xs px-2 py-1 transition duration-500 rounded-full border text-neutral-100 bg-neutral-400/10 border-white dark:text-neutral-800 dark:bg-neutral-600/10 dark:border-black],
    ...
    # alerts
    info_alert_title_frame: %w[z-10 fixed top-14 left-1 right-1 md:top-26 md:left-auto md:right-8 min-w-sm w-auto md:min-w-xl font-medium rounded-md backdrop-blur-lg p-4 mx-2 my-4 transition-transform scale-0 open:scale-100 duration-2000 border border-green-500 bg-green-100/30 text-green-700 dark:bg-green-900/30 dark:text-green-300],
    success_alert_title_frame: %w[z-10 fixed top-14 left-1 right-1 md:top-26 md:left-auto md:right-8 min-w-sm w-auto md:min-w-xl font-medium rounded-md backdrop-blur-lg p-4 mx-2 my-4 transition-transform scale-0 open:scale-100 duration-2000 border border-green-700 bg-green-300/30 text-green-700 dark:border-green-300 dark:bg-green-700/30 dark:text-green-300],
    warning_alert_title_frame: %w[z-10 fixed top-14 left-1 right-1 md:top-26 md:left-auto md:right-8 min-w-sm w-auto md:min-w-xl font-medium rounded-md backdrop-blur-lg p-4 mx-2 my-4 transition-transform scale-0 open:scale-100 duration-2000 border border-orange-700 bg-orange-300/30 text-orange-700 dark:border-orange-300 dark:bg-orange-700/30 dark:text-orange-300],
    danger_alert_title_frame: %w[z-10 fixed top-14 left-1 right-1 md:top-26 md:left-auto md:right-8 min-w-sm w-auto md:min-w-xl font-medium rounded-md backdrop-blur-lg p-4 mx-2 my-4 transition-transform scale-0 open:scale-100 duration-2000 border border-red-700 bg-red-300/30 text-red-700 dark:border-red-300 dark:bg-red-700/30 dark:text-red-300]
  }.freeze
