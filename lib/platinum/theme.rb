...
class Platinum::Theme
  ...
  DEFAULT_CONFIG = {
    ...
    toolbar_container: %w[flex flex-col overflow-y-auto flex-nowrap gap-1 p-1 items-stretch justify-start md:items-center ms:justify-start rounded-md backdrop-blur-lg border border-neutral-50 bg-white/30 text-neutral-800 dark:border-neutral-900 dark:bg-black/30 dark:text-neutral-200],
