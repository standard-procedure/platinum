...
class Platinum::Flex < Platinum::Base
  ...
  DIRECTION = {row: "flex-row flex-no-wrap overflow-hidden", wrapped_row: "flex-row flex-wrap overflow-hidden", scrolling_row: "flex-row flex-nowrap overflow-y-hidden overflow-x-auto", column: "flex-col flex-nowrap", wrapped_column: "flex-col flex-wrap overflow-hidden"}
